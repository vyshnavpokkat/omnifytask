...
export const MobileNavbar: React.FC = () => {
    ...
    const renderTimezoneForm = () => (
        <form className="w-11/12 mx-auto text-gray-900 text-sm bg-dark-box shadow-md transition-all duration-300 ease-in-out">
            ...
            <div className='flex justify-center items-center bg-dark-box transition-all duration-300 ease-in-out'>
                <Image
                    width={20} height={20}
                    src='assets/ic_time_zone.svg'
                    className="w-6 h-6 ml-2 transition-all duration-300 ease-in-out"
                    alt="Time Zone Icon"
                />
    ...
    const renderFooter = () => (
        <div className="mx-auto pb-5 space-y-2 mt-4">
            <div
                className="flex items-center justify-center p-2 text-gray-900 rounded-lg hover:bg-white hover:shadow-md transition-all duration-300 cursor-pointer"
                data-aos="fade-up"
            >
                <Image
                    width={20} height={20}
                    src='assets/ic_db.svg'
                    className="w-5 h-5"
                    alt="Dashboard Icon"
                />
                ...
                <Image
                    width={20} height={20}
                    src='assets/ic_db_secondary.svg'
                    className="w-5 h-5"
                    alt="Dashboard Icon"
                />
            </div>
            <div
                className="flex justify-between items-center p-2 text-gray-900 rounded-lg bg-white shadow-md transition-all duration-300 cursor-pointer"
                data-aos="fade-up"
            >
                <div className='flex items-center'>
                    <Image
                        width={20} height={20}
                        src='assets/ic_admin.svg'
                        className="w-9 h-9"
                        alt="Admin Icon"
                    />
                ...
                <Image
                    width={20} height={20}
                    src='assets/ic_arrow_bottom.svg'
                    className="w-5 h-5"
                    alt="Arrow Icon"
                />
            </div>
            <div
                className="flex items-center p-2 text-gray-900 rounded-lg mx-3 cursor-pointer"
                data-aos="fade-up"
            >
                <Image
                    width={20} height={20}
                    src='assets/ic_help.svg'
                    className="w-5 h-5"
